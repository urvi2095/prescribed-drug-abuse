...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 404, 91));

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel1.setText("Name");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, 70, 29));
        ...
        add(submitJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, -1, -1));
        ...
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, 93, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 417, -1, -1));
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        try {
            if (nameJTextField.getText().isEmpty()) {
                ...
                boolean check = system.checkIfNetworkIsUnique(name);
                if (check) {
                    Network network = system.createAndAddNetwork();
                    network.setName(name);
                    //organization.getUserAccountDirectory().createUserAccount(userName, password, employee, role);
                    JOptionPane.showMessageDialog(null, "Network Added to EcoSystem successfully");
