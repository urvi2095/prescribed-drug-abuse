 ...
 * @author urvi
 */
public class CreateReceptionistRecordJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateClinicManagerRecordJPanel
     */
    ...
    public CreateReceptionistRecordJPanel(JPanel userProcessContainer, UserAccount account, ClinicOrganization organization, EcoSystem business) {
        initComponents();
    ...
    public void populateDetails(){
       ...
       ClinicManagerRole dr = (ClinicManagerRole) account.getRole();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create Receptionist Record");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon("/Users/urvi/Desktop/receptionist-icon.png")); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 70, 90));
        ...
        jButton1.setText("CREATE RECEPTIONIST RECORD");
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 490, 150, -1));

        jButton3.setBackground(new java.awt.Color(102, 204, 255));
        jButton3.setText("<<Back");
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 110, 40));
        jPanel1.add(dateDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 390, 200, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     {
     ClinicManagerRole cr = (ClinicManagerRole) account.getRole();
     cr.setFname(txtFname.getText());
     cr.setLname(txtLname.getText());
     cr.setAddress(txtAddress.getText());
     cr.setCity(txtCity.getText());
     cr.setDob(dateDOB.getDate());
     
     if (account.getRole().valPhone(txtPhone.getText())) {
            cr.setPhone(txtPhone.getText());
        } else {
     ...
     if (radioFemale.isSelected() || radioMale.isSelected()) {
            if (radioFemale.isSelected()) {
                cr.setGender(radioFemale.getText());
            } else if (radioMale.isSelected()) {
                cr.setGender(radioMale.getText());
            }
        } else {
